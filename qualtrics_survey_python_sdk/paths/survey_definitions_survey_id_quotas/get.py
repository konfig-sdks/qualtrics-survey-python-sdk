...
from qualtrics_survey_python_sdk.model.get_quotas_response import GetQuotasResponse as GetQuotasResponseSchema
...
from qualtrics_survey_python_sdk.type.get_quotas_response import GetQuotasResponse
...
from qualtrics_survey_python_sdk.pydantic.get_quotas_response import GetQuotasResponse as GetQuotasResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetQuotasResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetQuotasResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return GetQuotasResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetQuotasResponsePydantic, raw_response.body)
