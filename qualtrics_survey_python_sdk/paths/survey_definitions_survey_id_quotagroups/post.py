...
from qualtrics_survey_python_sdk.model.create_quota_group_response import CreateQuotaGroupResponse as CreateQuotaGroupResponseSchema
from qualtrics_survey_python_sdk.model.survey_id import SurveyID as SurveyIDSchema
from qualtrics_survey_python_sdk.model.quota_group import QuotaGroup as QuotaGroupSchema
...
from qualtrics_survey_python_sdk.type.create_quota_group_response import CreateQuotaGroupResponse
from qualtrics_survey_python_sdk.type.not_found_error_response import NotFoundErrorResponse
from qualtrics_survey_python_sdk.type.quota_group import QuotaGroup

from ...api_client import Dictionary
from qualtrics_survey_python_sdk.pydantic.create_quota_group_response import CreateQuotaGroupResponse as CreateQuotaGroupResponsePydantic
...
from qualtrics_survey_python_sdk.pydantic.quota_group import QuotaGroup as QuotaGroupPydantic
...
# body param
SchemaForRequestBodyApplicationJson = QuotaGroupSchema


request_body_quota_group = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CreateQuotaGroupResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: CreateQuotaGroupResponse
...
class BaseApi(api_client.Api):
    ...
    def _create_quota_group_mapped_args(
        self,
        id: QuotaGroupID,
        survey_id: SurveyID,
        id: typing.Optional[QuotaGroupID] = None,
        multiple_match: typing.Optional[str] = None,
        name: typing.Optional[str] = None,
        public: typing.Optional[bool] = None,
        quotas: typing.Optional[typing.List[QuotaID]] = None,
        ...
        if multiple_match is not None:
            _body["MultipleMatch"] = multiple_match
        if name is not None:
            _body["Name"] = name
    ...
    async def _acreate_quota_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/survey-definitions/{surveyId}/quotagroups',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_quota_group.serialize(body, content_type)
...
class CreateQuotaGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_quota_group(
        self,
        id: QuotaGroupID,
        survey_id: SurveyID,
        id: typing.Optional[QuotaGroupID] = None,
        ...
        **kwargs,
        ...
        args = self._create_quota_group_mapped_args(
            id=id,
            survey_id=survey_id,
            id=id,
        ...
        return await self._acreate_quota_group_oapg(
            body=args.body,
    ...
    def create_quota_group(
        ...
        return self._create_quota_group_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateQuotaGroup(BaseApi):
    ...
    async def acreate_quota_group(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CreateQuotaGroupResponsePydantic:
        raw_response = await self.raw.acreate_quota_group(
            id=id,
            survey_id=survey_id,
            id=id,
            multiple_match=multiple_match,
        ...
        if validate:
            return CreateQuotaGroupResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CreateQuotaGroupResponsePydantic, raw_response.body)
    ...
    def create_quota_group(
        ...
        raw_response = self.raw.create_quota_group(
            id=id,
            survey_id=survey_id,
            id=id,
            multiple_match=multiple_match,
