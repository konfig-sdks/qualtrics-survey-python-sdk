...
from qualtrics_survey_python_sdk.model.get_quota_groups_response import GetQuotaGroupsResponse as GetQuotaGroupsResponseSchema
...
from qualtrics_survey_python_sdk.type.get_quota_groups_response import GetQuotaGroupsResponse
...
from qualtrics_survey_python_sdk.pydantic.get_quota_groups_response import GetQuotaGroupsResponse as GetQuotaGroupsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetQuotaGroupsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetQuotaGroupsResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_quota_groups_mapped_args(
        self,
        survey_id: SurveyID,
    ...
    async def _alist_quota_groups_oapg(
        self,
...
class ListQuotaGroupsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_quota_groups(
        self,
        survey_id: SurveyID,
        page_size: typing.Optional[int] = None,
        skip_token: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_quota_groups_mapped_args(
            survey_id=survey_id,
            page_size=page_size,
            skip_token=skip_token,
        )
        return await self._alist_quota_groups_oapg(
    ...
    def list_quota_groups(
        ...
        return self._list_quota_groups_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListQuotaGroups(BaseApi):
    ...
    async def alist_quota_groups(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetQuotaGroupsResponsePydantic:
        raw_response = await self.raw.alist_quota_groups(
            survey_id=survey_id,
            page_size=page_size,
            skip_token=skip_token,
            **kwargs,
        ...
        if validate:
            return GetQuotaGroupsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetQuotaGroupsResponsePydantic, raw_response.body)
    ...
    def list_quota_groups(
        ...
        raw_response = self.raw.list_quota_groups(
            survey_id=survey_id,
            page_size=page_size,
            skip_token=skip_token,
        )
