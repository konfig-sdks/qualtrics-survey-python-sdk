...
from qualtrics_survey_python_sdk.model.translations_response import TranslationsResponse as TranslationsResponseSchema
...
from qualtrics_survey_python_sdk.type.translations_response import TranslationsResponse
...
from qualtrics_survey_python_sdk.pydantic.translations_response import TranslationsResponse as TranslationsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = TranslationsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TranslationsResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_by_survey_id_and_language_code_mapped_args(
        self,
        survey_id: str,
        language_code: str,
    ...
    async def _aget_by_survey_id_and_language_code_oapg(
        self,
    ...
    def _get_by_survey_id_and_language_code_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetBySurveyIdAndLanguageCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_survey_id_and_language_code(
        self,
        survey_id: str,
        language_code: str,
        **kwargs,
        ...
        args = self._get_by_survey_id_and_language_code_mapped_args(
            survey_id=survey_id,
            language_code=language_code,
        )
        return await self._aget_by_survey_id_and_language_code_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_survey_id_and_language_code(
        self,
        survey_id: str,
        language_code: str,
    ) -> typing.Union[
        ...
        return self._get_by_survey_id_and_language_code_oapg(
            path_params=args.path,
        )

class GetBySurveyIdAndLanguageCode(BaseApi):
    ...
    async def aget_by_survey_id_and_language_code(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TranslationsResponsePydantic:
        raw_response = await self.raw.aget_by_survey_id_and_language_code(
            survey_id=survey_id,
            language_code=language_code,
            **kwargs,
        )
        if validate:
            return TranslationsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TranslationsResponsePydantic, raw_response.body)
    ...
    def get_by_survey_id_and_language_code(
        ...
        raw_response = self.raw.get_by_survey_id_and_language_code(
            survey_id=survey_id,
            language_code=language_code,
        )
        if validate:
