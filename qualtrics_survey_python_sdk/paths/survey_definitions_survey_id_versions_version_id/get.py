...
from qualtrics_survey_python_sdk.model.get_survey_version_response import GetSurveyVersionResponse as GetSurveyVersionResponseSchema
...
from qualtrics_survey_python_sdk.model.version_id import VersionID as VersionIDSchema
...
from qualtrics_survey_python_sdk.type.get_survey_version_response import GetSurveyVersionResponse
...
from qualtrics_survey_python_sdk.type.version_id import VersionID
...
from qualtrics_survey_python_sdk.pydantic.version_id import VersionID as VersionIDPydantic
from qualtrics_survey_python_sdk.pydantic.get_survey_version_response import GetSurveyVersionResponse as GetSurveyVersionResponsePydantic
...
VersionIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'surveyId': typing.Union[SurveyIDSchema, ],
        'versionId': typing.Union[VersionIDSchema, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = GetSurveyVersionResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetSurveyVersionResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_definition_mapped_args(
        self,
        survey_id: SurveyID,
    ...
    async def _aget_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/survey-definitions/{surveyId}/versions/{versionId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDefinitionRaw(BaseApi):
    ...
    async def aget_definition(
        ...
        **kwargs,
        ...
        args = self._get_definition_mapped_args(
            survey_id=survey_id,
            version_id=version_id,
            format=format,
        )
        return await self._aget_definition_oapg(
...
class GetDefinition(BaseApi):
    ...
    async def aget_definition(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetSurveyVersionResponsePydantic:
        raw_response = await self.raw.aget_definition(
            survey_id=survey_id,
            version_id=version_id,
            format=format,
            **kwargs,
        ...
        if validate:
            return GetSurveyVersionResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetSurveyVersionResponsePydantic, raw_response.body)
    ...
    def get_definition(
        ...
        raw_response = self.raw.get_definition(
            survey_id=survey_id,
            version_id=version_id,
            format=format,
        )
