...
QuestionIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'surveyId': typing.Union[SurveyIDSchema, ],
        'questionId': typing.Union[QuestionIDSchema, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = QuestionDefinitionSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: QuestionDefinition
    ...
    async def _aget_definition_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/survey-definitions/{surveyId}/questions/{questionId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDefinition(BaseApi):
    ...
    async def aget_definition(
        ...
        **kwargs,
        ...
        if validate:
            return RootModel[QuestionDefinitionPydantic](raw_response.body).root
        return api_client.construct_model_instance(QuestionDefinitionPydantic, raw_response.body)
