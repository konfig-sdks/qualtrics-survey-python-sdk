...
class BaseApi(api_client.Api):
    ...
    def _remove_question_mapped_args(
        self,
        survey_id: SurveyID,
    ...
    async def _aremove_question_oapg(
        self,
...
class RemoveQuestionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_question(
        self,
        survey_id: SurveyID,
        question_id: QuestionID,
        **kwargs,
        ...
        args = self._remove_question_mapped_args(
            survey_id=survey_id,
            question_id=question_id,
        )
        return await self._aremove_question_oapg(
    ...
    def remove_question(
        ...
        return self._remove_question_oapg(
            path_params=args.path,
        )

class RemoveQuestion(BaseApi):
    ...
    async def aremove_question(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_question(
            survey_id=survey_id,
            question_id=question_id,
            **kwargs,
        )
    ...
    def remove_question(
        ...
        raw_response = self.raw.remove_question(
            survey_id=survey_id,
            question_id=question_id,
        )
        if validate:
