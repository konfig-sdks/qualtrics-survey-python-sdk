...
from qualtrics_survey_python_sdk.model.survey_language_elements import SurveyLanguageElements as SurveyLanguageElementsSchema
...
from qualtrics_survey_python_sdk.model.survey_languages import SurveyLanguages as SurveyLanguagesSchema
...
from qualtrics_survey_python_sdk.type.survey_languages import SurveyLanguages
from qualtrics_survey_python_sdk.type.survey_language_elements import SurveyLanguageElements
from qualtrics_survey_python_sdk.type.request_successful_response import RequestSuccessfulResponse

from ...api_client import Dictionary
from qualtrics_survey_python_sdk.pydantic.survey_languages import SurveyLanguages as SurveyLanguagesPydantic
...
from qualtrics_survey_python_sdk.pydantic.survey_language_elements import SurveyLanguageElements as SurveyLanguageElementsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = SurveyLanguagesSchema


request_body_survey_languages = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_enabled_languages_mapped_args(
        self,
        available_languages: SurveyLanguageElements,
        survey_id: str,
    ...
    async def _aupdate_enabled_languages_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_survey_languages.serialize(body, content_type)
    ...
    def _update_enabled_languages_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateEnabledLanguagesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_enabled_languages(
        self,
        available_languages: SurveyLanguageElements,
        survey_id: str,
        **kwargs,
        ...
        args = self._update_enabled_languages_mapped_args(
            available_languages=available_languages,
            survey_id=survey_id,
        )
        return await self._aupdate_enabled_languages_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_enabled_languages(
        self,
        available_languages: SurveyLanguageElements,
        survey_id: str,
    ) -> typing.Union[
        ...
        return self._update_enabled_languages_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateEnabledLanguages(BaseApi):
    ...
    async def aupdate_enabled_languages(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_enabled_languages(
            available_languages=available_languages,
            survey_id=survey_id,
            **kwargs,
        )
    ...
    def update_enabled_languages(
        ...
        raw_response = self.raw.update_enabled_languages(
            available_languages=available_languages,
            survey_id=survey_id,
        )
        if validate:
