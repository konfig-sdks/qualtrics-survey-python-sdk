...
FlowIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'surveyId': typing.Union[SurveyIDSchema, ],
        'flowId': typing.Union[FlowIDSchema, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = FlowSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_flow_element_definition_mapped_args(
        self,
        survey_id: SurveyID,
        flow_id: FlowID,
        body: typing.Optional[Flow] = None,
    ...
    async def _aupdate_flow_element_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        """
        Updates Flow Element Definition
        ...
        request_before_hook(
            ...
            path_template='/survey-definitions/{surveyId}/flow/{flowId}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_flow_element_definition_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateFlowElementDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_flow_element_definition(
        self,
        survey_id: SurveyID,
        flow_id: FlowID,
        body: typing.Optional[Flow] = None,
        **kwargs,
        ...
        args = self._update_flow_element_definition_mapped_args(
            body=body,
            survey_id=survey_id,
            flow_id=flow_id,
        )
        return await self._aupdate_flow_element_definition_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_flow_element_definition(
        self,
        survey_id: SurveyID,
        flow_id: FlowID,
        body: typing.Optional[Flow] = None,
        ...
        return self._update_flow_element_definition_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateFlowElementDefinition(BaseApi):
    ...
    async def aupdate_flow_element_definition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_flow_element_definition(
            body=body,
            survey_id=survey_id,
            flow_id=flow_id,
            **kwargs,
    ...
    def update_flow_element_definition(
        ...
        raw_response = self.raw.update_flow_element_definition(
            body=body,
            survey_id=survey_id,
            flow_id=flow_id,
        )
