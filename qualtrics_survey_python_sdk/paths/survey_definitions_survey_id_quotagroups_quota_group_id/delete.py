...
class BaseApi(api_client.Api):
    ...
    def _remove_quota_group_mapped_args(
        self,
        survey_id: SurveyID,
    ...
    async def _aremove_quota_group_oapg(
        self,
...
class RemoveQuotaGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_quota_group(
        self,
        survey_id: SurveyID,
        quota_group_id: QuotaGroupID,
        **kwargs,
        ...
        args = self._remove_quota_group_mapped_args(
            survey_id=survey_id,
            quota_group_id=quota_group_id,
        )
        return await self._aremove_quota_group_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def remove_quota_group(
        self,
        survey_id: SurveyID,
        quota_group_id: QuotaGroupID,
    ) -> typing.Union[
        ...
        return self._remove_quota_group_oapg(
            path_params=args.path,
        )

class RemoveQuotaGroup(BaseApi):
    ...
    async def aremove_quota_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_quota_group(
            survey_id=survey_id,
            quota_group_id=quota_group_id,
            **kwargs,
        )
    ...
    def remove_quota_group(
        ...
        raw_response = self.raw.remove_quota_group(
            survey_id=survey_id,
            quota_group_id=quota_group_id,
        )
        if validate:
