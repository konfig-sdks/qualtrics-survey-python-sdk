...
class BaseApi(api_client.Api):
    ...
    def _update_quota_group_definition_mapped_args(
        self,
        id: QuotaGroupID,
        survey_id: SurveyID,
    ...
    async def _aupdate_quota_group_definition_oapg(
        self,
    ...
    def _update_quota_group_definition_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateQuotaGroupDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_quota_group_definition(
        self,
        id: QuotaGroupID,
        survey_id: SurveyID,
        quota_group_id: QuotaGroupID,
        ...
        **kwargs,
        ...
        args = self._update_quota_group_definition_mapped_args(
            id=id,
            survey_id=survey_id,
        ...
        return await self._aupdate_quota_group_definition_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_quota_group_definition(
        self,
        id: QuotaGroupID,
        survey_id: SurveyID,
        quota_group_id: QuotaGroupID,
        ...
        return self._update_quota_group_definition_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateQuotaGroupDefinition(BaseApi):
    ...
    async def aupdate_quota_group_definition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_quota_group_definition(
            id=id,
            survey_id=survey_id,
            quota_group_id=quota_group_id,
            id=id,
    ...
    def update_quota_group_definition(
        ...
        raw_response = self.raw.update_quota_group_definition(
            id=id,
            survey_id=survey_id,
            quota_group_id=quota_group_id,
            id=id,
