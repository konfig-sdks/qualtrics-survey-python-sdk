...
from qualtrics_survey_python_sdk.model.get_quota_group_response import GetQuotaGroupResponse as GetQuotaGroupResponseSchema
...
from qualtrics_survey_python_sdk.type.get_quota_group_response import GetQuotaGroupResponse
...
from qualtrics_survey_python_sdk.pydantic.get_quota_group_response import GetQuotaGroupResponse as GetQuotaGroupResponsePydantic
...
request_path_quota_group_id = api_client.PathParameter(
    name="quotaGroupId",
    style=api_client.ParameterStyle.SIMPLE,
    schema=QuotaGroupIDSchema,
    required=True,
)
SchemaFor200ResponseBodyApplicationJson = GetQuotaGroupResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetQuotaGroupResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_quota_group_definition_mapped_args(
        self,
        survey_id: SurveyID,
        ...
        if quota_group_id is not None:
            _path_params["quotaGroupId"] = quota_group_id
        args.path = _path_params
        return args

    async def _aget_quota_group_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/survey-definitions/{surveyId}/quotagroups/{quotaGroupId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_quota_group_definition_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetQuotaGroupDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_quota_group_definition(
        self,
        survey_id: SurveyID,
        quota_group_id: QuotaGroupID,
        **kwargs,
        ...
        args = self._get_quota_group_definition_mapped_args(
            survey_id=survey_id,
            quota_group_id=quota_group_id,
        )
        return await self._aget_quota_group_definition_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_quota_group_definition(
        self,
        survey_id: SurveyID,
        quota_group_id: QuotaGroupID,
    ) -> typing.Union[
        ...
        return self._get_quota_group_definition_oapg(
            path_params=args.path,
        )

class GetQuotaGroupDefinition(BaseApi):
    ...
    async def aget_quota_group_definition(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetQuotaGroupResponsePydantic:
        raw_response = await self.raw.aget_quota_group_definition(
            survey_id=survey_id,
            quota_group_id=quota_group_id,
            **kwargs,
        )
        if validate:
            return GetQuotaGroupResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetQuotaGroupResponsePydantic, raw_response.body)
    ...
    def get_quota_group_definition(
        ...
        raw_response = self.raw.get_quota_group_definition(
            survey_id=survey_id,
            quota_group_id=quota_group_id,
        )
        if validate:
