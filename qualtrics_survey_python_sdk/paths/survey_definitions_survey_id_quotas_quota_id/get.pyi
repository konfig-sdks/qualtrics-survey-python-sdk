...
from qualtrics_survey_python_sdk.model.get_quota_response import GetQuotaResponse as GetQuotaResponseSchema
...
from qualtrics_survey_python_sdk.type.get_quota_response import GetQuotaResponse
...
from qualtrics_survey_python_sdk.pydantic.get_quota_response import GetQuotaResponse as GetQuotaResponsePydantic
...
QuotaIdSchema = schemas.Schema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'surveyId': typing.Union[SurveyIDSchema, ],
        'quotaId': typing.Union[QuotaIDSchema, ],
    }
)
...
SchemaFor200ResponseBodyApplicationJson = GetQuotaResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetQuotaResponse
    ...
    async def _aget_definition_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/survey-definitions/{surveyId}/quotas/{quotaId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDefinition(BaseApi):
    ...
    async def aget_definition(
        ...
        **kwargs,
        ...
        if validate:
            return GetQuotaResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetQuotaResponsePydantic, raw_response.body)
