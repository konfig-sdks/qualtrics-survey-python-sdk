...
class DeleteQuotaRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_quota(
        self,
        survey_id: SurveyID,
        quota_id: QuotaID,
        **kwargs,
        ...
        args = self._delete_quota_mapped_args(
            survey_id=survey_id,
            quota_id=quota_id,
        )
        return await self._adelete_quota_oapg(
    ...
    def delete_quota(
        ...
        return self._delete_quota_oapg(
            path_params=args.path,
        )

class DeleteQuota(BaseApi):
    ...
    async def adelete_quota(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_quota(
            survey_id=survey_id,
            quota_id=quota_id,
            **kwargs,
        )
    ...
    def delete_quota(
        ...
        raw_response = self.raw.delete_quota(
            survey_id=survey_id,
            quota_id=quota_id,
        )
        if validate:
