...
from qualtrics_survey_python_sdk.model.get_survey_options_response import GetSurveyOptionsResponse as GetSurveyOptionsResponseSchema
...
from qualtrics_survey_python_sdk.type.get_survey_options_response import GetSurveyOptionsResponse
...
from qualtrics_survey_python_sdk.pydantic.get_survey_options_response import GetSurveyOptionsResponse as GetSurveyOptionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetSurveyOptionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetSurveyOptionsResponse
...
class GetOptions(BaseApi):
    ...
    async def aget_options(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetSurveyOptionsResponsePydantic:
        raw_response = await self.raw.aget_options(
            survey_id=survey_id,
            **kwargs,
        )
        if validate:
            return GetSurveyOptionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetSurveyOptionsResponsePydantic, raw_response.body)
