...
from qualtrics_survey_python_sdk.model.delete_survey_response import DeleteSurveyResponse as DeleteSurveyResponseSchema
...
from qualtrics_survey_python_sdk.type.delete_survey_response import DeleteSurveyResponse
from qualtrics_survey_python_sdk.type.not_found_error_response import NotFoundErrorResponse

from ...api_client import Dictionary
from qualtrics_survey_python_sdk.pydantic.delete_survey_response import DeleteSurveyResponse as DeleteSurveyResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = DeleteSurveyResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DeleteSurveyResponse
...
class BaseApi(api_client.Api):
    ...
    def _remove_definition_mapped_args(
        self,
        survey_id: SurveyID,
    ...
    async def _aremove_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/survey-definitions/{surveyId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class RemoveDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_definition(
        self,
        survey_id: SurveyID,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_definition_mapped_args(
            survey_id=survey_id,
        )
        return await self._aremove_definition_oapg(
    ...
    def remove_definition(
        ...
        return self._remove_definition_oapg(
            path_params=args.path,
        )

class RemoveDefinition(BaseApi):
    ...
    async def aremove_definition(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DeleteSurveyResponsePydantic:
        raw_response = await self.raw.aremove_definition(
            survey_id=survey_id,
            **kwargs,
        )
        if validate:
            return DeleteSurveyResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(DeleteSurveyResponsePydantic, raw_response.body)
    ...
    def remove_definition(
        ...
        raw_response = self.raw.remove_definition(
            survey_id=survey_id,
        )
        if validate:
            return DeleteSurveyResponsePydantic(**raw_response.body)
