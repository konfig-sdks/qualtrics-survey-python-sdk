...
from qualtrics_survey_python_sdk.model.get_survey_response import GetSurveyResponse as GetSurveyResponseSchema
...
from qualtrics_survey_python_sdk.type.get_survey_response import GetSurveyResponse
...
from qualtrics_survey_python_sdk.pydantic.get_survey_response import GetSurveyResponse as GetSurveyResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetSurveyResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetSurveyResponse
...
class GetDefinition(BaseApi):
    ...
    async def aget_definition(
        ...
        **kwargs,
        ...
        if validate:
            return GetSurveyResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetSurveyResponsePydantic, raw_response.body)
