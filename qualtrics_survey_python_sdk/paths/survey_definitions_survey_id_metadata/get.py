...
from qualtrics_survey_python_sdk.model.metadata_response import MetadataResponse as MetadataResponseSchema
...
from qualtrics_survey_python_sdk.type.metadata_response import MetadataResponse
...
from qualtrics_survey_python_sdk.pydantic.metadata_response import MetadataResponse as MetadataResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = MetadataResponseSchema
...
class GetMetadata(BaseApi):
    ...
    async def aget_metadata(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MetadataResponsePydantic:
        raw_response = await self.raw.aget_metadata(
            survey_id=survey_id,
            **kwargs,
        )
        if validate:
            return MetadataResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(MetadataResponsePydantic, raw_response.body)
