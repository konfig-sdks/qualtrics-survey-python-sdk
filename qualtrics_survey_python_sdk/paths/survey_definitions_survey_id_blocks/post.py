...
from qualtrics_survey_python_sdk.model.create_block_response import CreateBlockResponse as CreateBlockResponseSchema
...
from qualtrics_survey_python_sdk.type.create_block_response import CreateBlockResponse
...
from qualtrics_survey_python_sdk.pydantic.create_block_response import CreateBlockResponse as CreateBlockResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = CreateBlockResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_block_mapped_args(
        self,
        survey_id: SurveyID,
    ...
    async def _acreate_new_block_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/survey-definitions/{surveyId}/blocks',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class CreateNewBlockRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_block(
        self,
        survey_id: SurveyID,
        block_elements: typing.Optional[BlockElements] = None,
        type: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._create_new_block_mapped_args(
            body=body,
            survey_id=survey_id,
        ...
        return await self._acreate_new_block_oapg(
            body=args.body,
    ...
    def create_new_block(
        ...
        return self._create_new_block_oapg(
            body=args.body,
            path_params=args.path,
        )

class CreateNewBlock(BaseApi):
    ...
    async def acreate_new_block(
        ...
        validate: bool = False,
        **kwargs,
    ) -> CreateBlockResponsePydantic:
        raw_response = await self.raw.acreate_new_block(
            body=body,
            survey_id=survey_id,
            block_elements=block_elements,
            type=type,
        ...
        if validate:
            return CreateBlockResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(CreateBlockResponsePydantic, raw_response.body)
    ...
    def create_new_block(
        ...
        raw_response = self.raw.create_new_block(
            body=body,
            survey_id=survey_id,
            block_elements=block_elements,
            type=type,
