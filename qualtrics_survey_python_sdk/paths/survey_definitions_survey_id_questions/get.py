...
from qualtrics_survey_python_sdk.model.get_questions_response import GetQuestionsResponse as GetQuestionsResponseSchema
...
from qualtrics_survey_python_sdk.type.get_questions_response import GetQuestionsResponse
...
from qualtrics_survey_python_sdk.pydantic.get_questions_response import GetQuestionsResponse as GetQuestionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetQuestionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetQuestionsResponse
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetQuestionsResponsePydantic:
        raw_response = await self.raw.aget_list(
            survey_id=survey_id,
            **kwargs,
        )
        if validate:
            return GetQuestionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetQuestionsResponsePydantic, raw_response.body)
