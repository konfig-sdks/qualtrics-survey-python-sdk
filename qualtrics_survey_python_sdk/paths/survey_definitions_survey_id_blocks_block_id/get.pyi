...
from qualtrics_survey_python_sdk.model.get_block_response import GetBlockResponse as GetBlockResponseSchema
...
from qualtrics_survey_python_sdk.type.get_block_response import GetBlockResponse
...
from qualtrics_survey_python_sdk.pydantic.get_block_response import GetBlockResponse as GetBlockResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetBlockResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: GetBlockResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_definition_block_mapped_args(
        self,
        survey_id: SurveyID,
        block_id: BlockID,
    ...
    async def _aget_definition_block_oapg(
        self,
    ...
    def _get_definition_block_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetDefinitionBlockRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_definition_block(
        self,
        survey_id: SurveyID,
        block_id: BlockID,
        **kwargs,
        ...
        args = self._get_definition_block_mapped_args(
            survey_id=survey_id,
            block_id=block_id,
        )
        return await self._aget_definition_block_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_definition_block(
        self,
        survey_id: SurveyID,
        block_id: BlockID,
    ) -> typing.Union[
        ...
        return self._get_definition_block_oapg(
            path_params=args.path,
        )

class GetDefinitionBlock(BaseApi):
    ...
    async def aget_definition_block(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetBlockResponsePydantic:
        raw_response = await self.raw.aget_definition_block(
            survey_id=survey_id,
            block_id=block_id,
            **kwargs,
        )
        if validate:
            return GetBlockResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetBlockResponsePydantic, raw_response.body)
    ...
    def get_definition_block(
        ...
        raw_response = self.raw.get_definition_block(
            survey_id=survey_id,
            block_id=block_id,
        )
        if validate:
