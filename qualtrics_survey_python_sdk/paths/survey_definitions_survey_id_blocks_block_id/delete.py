...
class RemoveBlockRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_block(
        self,
        survey_id: SurveyID,
        block_id: BlockID,
        **kwargs,
        ...
        args = self._remove_block_mapped_args(
            survey_id=survey_id,
            block_id=block_id,
        )
        return await self._aremove_block_oapg(
    ...
    def remove_block(
        ...
        return self._remove_block_oapg(
            path_params=args.path,
        )

class RemoveBlock(BaseApi):
    ...
    async def aremove_block(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_block(
            survey_id=survey_id,
            block_id=block_id,
            **kwargs,
        )
    ...
    def remove_block(
        ...
        raw_response = self.raw.remove_block(
            survey_id=survey_id,
            block_id=block_id,
        )
        if validate:
