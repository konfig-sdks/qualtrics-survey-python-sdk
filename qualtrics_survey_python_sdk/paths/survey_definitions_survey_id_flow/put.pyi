...
from qualtrics_survey_python_sdk.model.flow_definition import FlowDefinition as FlowDefinitionSchema
...
from qualtrics_survey_python_sdk.model.flow_id import FlowID as FlowIDSchema
...
from qualtrics_survey_python_sdk.model.flow_properties import FlowProperties as FlowPropertiesSchema
from qualtrics_survey_python_sdk.model.survey_id import SurveyID as SurveyIDSchema
from qualtrics_survey_python_sdk.model.flow_type import FlowType as FlowTypeSchema
...
from qualtrics_survey_python_sdk.model.flow import Flow as FlowSchema
...
from qualtrics_survey_python_sdk.type.flow_properties import FlowProperties
...
from qualtrics_survey_python_sdk.type.flow_type import FlowType
...
from qualtrics_survey_python_sdk.pydantic.flow_type import FlowType as FlowTypePydantic
from qualtrics_survey_python_sdk.pydantic.flow_definition import FlowDefinition as FlowDefinitionPydantic
from qualtrics_survey_python_sdk.pydantic.flow_properties import FlowProperties as FlowPropertiesPydantic
...
from qualtrics_survey_python_sdk.pydantic.flow import Flow as FlowPydantic
from qualtrics_survey_python_sdk.pydantic.flow_id import FlowID as FlowIDPydantic
...
# body param
SchemaForRequestBodyApplicationJson = FlowDefinitionSchema


request_body_flow_definition = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_definition_mapped_args(
        self,
        flow_id: FlowID,
        type: FlowType,
        flow: Flow,
    ...
    async def _aupdate_definition_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/survey-definitions/{surveyId}/flow',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_flow_definition.serialize(body, content_type)
...
class UpdateDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_definition(
        self,
        flow_id: FlowID,
        type: FlowType,
        flow: Flow,
        ...
        **kwargs,
        ...
        args = self._update_definition_mapped_args(
            flow_id=flow_id,
            type=type,
            flow=flow,
        ...
        return await self._aupdate_definition_oapg(
            body=args.body,
    ...
    def update_definition(
        ...
        return self._update_definition_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateDefinition(BaseApi):
    ...
    async def aupdate_definition(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_definition(
            flow_id=flow_id,
            type=type,
            flow=flow,
            properties=properties,
    ...
    def update_definition(
        ...
        raw_response = self.raw.update_definition(
            flow_id=flow_id,
            type=type,
            flow=flow,
            properties=properties,
