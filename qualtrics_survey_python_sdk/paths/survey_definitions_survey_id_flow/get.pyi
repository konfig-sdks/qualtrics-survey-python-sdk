...
from qualtrics_survey_python_sdk.model.get_flow_response import GetFlowResponse as GetFlowResponseSchema
...
from qualtrics_survey_python_sdk.type.get_flow_response import GetFlowResponse

from ...api_client import Dictionary
from qualtrics_survey_python_sdk.pydantic.get_flow_response import GetFlowResponse as GetFlowResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = GetFlowResponseSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_flow_definition_mapped_args(
        self,
        survey_id: SurveyID,
    ...
    async def _aget_flow_definition_oapg(
        self,
...
class GetFlowDefinitionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_flow_definition(
        self,
        survey_id: SurveyID,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_flow_definition_mapped_args(
            survey_id=survey_id,
        )
        return await self._aget_flow_definition_oapg(
    ...
    def get_flow_definition(
        ...
        return self._get_flow_definition_oapg(
            path_params=args.path,
        )

class GetFlowDefinition(BaseApi):
    ...
    async def aget_flow_definition(
        ...
        validate: bool = False,
        **kwargs,
    ) -> GetFlowResponsePydantic:
        raw_response = await self.raw.aget_flow_definition(
            survey_id=survey_id,
            **kwargs,
        )
        if validate:
            return GetFlowResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(GetFlowResponsePydantic, raw_response.body)
    ...
    def get_flow_definition(
        ...
        raw_response = self.raw.get_flow_definition(
            survey_id=survey_id,
        )
        if validate:
            return GetFlowResponsePydantic(**raw_response.body)
