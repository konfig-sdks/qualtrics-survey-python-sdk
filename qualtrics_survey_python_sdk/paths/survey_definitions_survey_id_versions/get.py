...
from qualtrics_survey_python_sdk.model.list_survey_versions_response import ListSurveyVersionsResponse as ListSurveyVersionsResponseSchema
...
from qualtrics_survey_python_sdk.type.list_survey_versions_response import ListSurveyVersionsResponse
...
from qualtrics_survey_python_sdk.pydantic.list_survey_versions_response import ListSurveyVersionsResponse as ListSurveyVersionsResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ListSurveyVersionsResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListSurveyVersionsResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListSurveyVersionsResponsePydantic:
        raw_response = await self.raw.alist(
            survey_id=survey_id,
            **kwargs,
        )
        if validate:
            return ListSurveyVersionsResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ListSurveyVersionsResponsePydantic, raw_response.body)
