...
class RequiredRelationshipExpression(TypedDict):
...
class OptionalRelationshipExpression(TypedDict, total=False):
    Operator: ComparisonOperators

    # Operation.
    RightOperand: str

class RelationshipExpression(RequiredRelationshipExpression, OptionalRelationshipExpression):
    pass
