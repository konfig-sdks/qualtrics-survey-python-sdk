...
class RequiredGeoIPExpression(TypedDict):
...
class OptionalGeoIPExpression(TypedDict, total=False):
    # Operation.
    LeftOperand: str
...
class GeoIPExpression(RequiredGeoIPExpression, OptionalGeoIPExpression):
    pass
