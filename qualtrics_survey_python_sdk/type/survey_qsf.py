...
class RequiredSurveyQSF(TypedDict):
    SurveyEntry: SurveyMetadata

    SurveyElements: typing.List[SurveyElement]

class OptionalSurveyQSF(TypedDict, total=False):
    pass

class SurveyQSF(RequiredSurveyQSF, OptionalSurveyQSF):
    pass
