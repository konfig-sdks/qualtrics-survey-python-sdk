...
class RequiredGetBlockResponse(TypedDict):
    meta: SuccessfulMeta

    result: BlockDefinition

class OptionalGetBlockResponse(TypedDict, total=False):
    pass

class GetBlockResponse(RequiredGetBlockResponse, OptionalGetBlockResponse):
    pass
