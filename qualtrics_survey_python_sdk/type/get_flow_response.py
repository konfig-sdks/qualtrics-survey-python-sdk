...
class RequiredGetFlowResponse(TypedDict):
    meta: SuccessfulMeta

    result: FlowDefinition

class OptionalGetFlowResponse(TypedDict, total=False):
    pass

class GetFlowResponse(RequiredGetFlowResponse, OptionalGetFlowResponse):
    pass
