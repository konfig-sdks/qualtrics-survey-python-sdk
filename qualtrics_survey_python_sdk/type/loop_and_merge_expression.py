...
class RequiredLoopAndMergeExpression(TypedDict):
...
class OptionalLoopAndMergeExpression(TypedDict, total=False):
    LeftOperand: BlockID
...
class LoopAndMergeExpression(RequiredLoopAndMergeExpression, OptionalLoopAndMergeExpression):
    pass
