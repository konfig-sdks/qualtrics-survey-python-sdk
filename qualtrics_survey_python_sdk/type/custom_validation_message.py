...
class RequiredCustomValidationMessage(TypedDict):
    libraryID: LibraryID
...
class OptionalCustomValidationMessage(TypedDict, total=False):
    # A user-provided description of the custom validation.
    description: str

class CustomValidationMessage(RequiredCustomValidationMessage, OptionalCustomValidationMessage):
    pass
