...
class RequiredQuestionExpression(TypedDict):
    ...
    QuestionIsInLoop: str

    # The type of question expression.
    Type: str

class OptionalQuestionExpression(TypedDict, total=False):
    pass

class QuestionExpression(RequiredQuestionExpression, OptionalQuestionExpression):
    pass
