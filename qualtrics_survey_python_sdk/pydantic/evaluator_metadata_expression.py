...
class EvaluatorMetadataExpression(BaseModel):
    # Logic type of the evaluator metadata expression.
    logic_type: Literal["EvaluatorMetadata"] = Field(alias='LogicType')
    ...
    # Person meta data.
    person_meta: str = Field(alias='PersonMeta')
    ...
    # Same as subject.
    same_as_subject_right_operand: typing.Optional[str] = Field(None, alias='SameAsSubjectRightOperand')
    class Config:
