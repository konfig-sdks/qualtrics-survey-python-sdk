...
from qualtrics_survey_python_sdk.pydantic.table_of_contents_flow_element_options import TableOfContentsFlowElementOptions

class TableOfContentsFlowElement(BaseModel):
    # The type of table of contents flow element.
    type: typing.Optional[Literal["TableOfContents"]] = Field(None, alias='Type')
    ...
    options: typing.Optional[TableOfContentsFlowElementOptions] = Field(None, alias='Options')
