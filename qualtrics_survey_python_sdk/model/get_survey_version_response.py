...
class GetSurveyVersionResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def result() -> typing.Type['SurveyDefinition']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["result"]) -> 'SurveyDefinition': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["result"]) -> 'SurveyDefinition': ...
