...
class CreateSurveyVersionResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def result() -> typing.Type['CreateSurveyVersionResponseResult']:
                return CreateSurveyVersionResponseResult
            __annotations__ = {
                "meta": meta,
                "result": result,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["result"]) -> 'CreateSurveyVersionResponseResult': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["result"]) -> 'CreateSurveyVersionResponseResult': ...
