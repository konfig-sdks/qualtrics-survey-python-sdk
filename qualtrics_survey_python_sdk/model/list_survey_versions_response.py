...
class ListSurveyVersionsResponse(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def result() -> typing.Type['ListSurveyVersionsResponseResult']:
                return ListSurveyVersionsResponseResult
            __annotations__ = {
                "meta": meta,
                "result": result,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["result"]) -> 'ListSurveyVersionsResponseResult': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["result"]) -> 'ListSurveyVersionsResponseResult': ...
