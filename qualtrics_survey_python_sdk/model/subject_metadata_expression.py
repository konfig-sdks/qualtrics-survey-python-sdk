...
class SubjectMetadataExpression(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class LogicType(
                ...
                def SUBJECT_METADATA(cls):
                    return cls("SubjectMetadata")
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Type"], typing_extensions.Literal["Description"], typing_extensions.Literal["LogicType"], typing_extensions.Literal["LeftOperand"], typing_extensions.Literal["PersonMeta"], typing_extensions.Literal["Operator"], typing_extensions.Literal["RightOperand"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Type"], typing_extensions.Literal["Description"], typing_extensions.Literal["LogicType"], typing_extensions.Literal["LeftOperand"], typing_extensions.Literal["PersonMeta"], typing_extensions.Literal["Operator"], typing_extensions.Literal["RightOperand"], str, ]):
