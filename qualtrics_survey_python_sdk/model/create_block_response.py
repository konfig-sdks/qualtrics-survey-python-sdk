...
class CreateBlockResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def result() -> typing.Type['CreateBlockResponseResult']:
                return CreateBlockResponseResult
            __annotations__ = {
                "meta": meta,
                "result": result,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["result"]) -> 'CreateBlockResponseResult': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["result"]) -> 'CreateBlockResponseResult': ...
