...
class ErrorMessage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["errorMessage"], typing_extensions.Literal["errorCode"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["errorMessage"], typing_extensions.Literal["errorCode"], str, ]):
