...
class GroupFlowElement(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Type"], typing_extensions.Literal["FlowID"], typing_extensions.Literal["Description"], typing_extensions.Literal["Flow"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Type"], typing_extensions.Literal["FlowID"], typing_extensions.Literal["Description"], typing_extensions.Literal["Flow"], str, ]):
