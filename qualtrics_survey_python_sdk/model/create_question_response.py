...
class CreateQuestionResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def result() -> typing.Type['CreateQuestionResponseResult']:
                return CreateQuestionResponseResult
            __annotations__ = {
                "meta": meta,
                "result": result,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["result"]) -> 'CreateQuestionResponseResult': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["result"]) -> 'CreateQuestionResponseResult': ...
