...
class GetFlowResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def result() -> typing.Type['FlowDefinition']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["result"]) -> 'FlowDefinition': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["result"]) -> 'FlowDefinition': ...
