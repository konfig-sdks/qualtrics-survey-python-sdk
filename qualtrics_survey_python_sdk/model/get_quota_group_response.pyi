...
class GetQuotaGroupResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def result() -> typing.Type['QuotaGroup']:
                return QuotaGroup
            __annotations__ = {
                "meta": meta,
                "result": result,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["result"]) -> 'QuotaGroup': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["result"]) -> 'QuotaGroup': ...
