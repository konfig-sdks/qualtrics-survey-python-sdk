...
class Selection(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["Display"], str, ]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["Display"], str, ]):
